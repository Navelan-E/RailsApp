...
ActiveRecord::Schema[7.1].define(version: 2026_05_11_114320) do
  ...
  create_table "mechanics", force: :cascade do |t|
    ...
    t.index ["invitation_token"], name: "index_mechanics_on_invitation_token", unique: true
    t.index ["invited_by_id"], name: "index_mechanics_on_invited_by_id"
    t.index ["invited_by_type", "invited_by_id"], name: "index_mechanics_on_invited_by"
    t.index ["reset_password_token"], name: "index_mechanics_on_reset_password_token", unique: true
    t.index ["unlock_token"], name: "index_mechanics_on_unlock_token", unique: true
  end
